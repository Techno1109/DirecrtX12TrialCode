...
DofPass::DofPass(Microsoft::WRL::ComPtr<ID3D12Device>& Dev, std::string ShaderPath, int Priority) :PassRenderer(Dev, ShaderPath, Priority, PassRenderer::PassType::SHADER)
{
	Init(ShaderPath);
...
void DofPass::DrawSetting(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& _CmdList, D3D12_VIEWPORT & _ViewPort, D3D12_RECT & _ScissorRect)
{
	//ルートシグネチャをセット
...
void DofPass::PassDraw(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& _CmdList)
{
...
void DofPass::Draw(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& _CmdList, D3D12_VIEWPORT & _ViewPort, D3D12_RECT & _ScissorRect, Microsoft::WRL::ComPtr<ID3D12DescriptorHeap>& _DepthBufferViewHeap)
{
}

void DofPass::PassClearAndSetRendererTarget(Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>& _CmdList, Microsoft::WRL::ComPtr<ID3D12DescriptorHeap>& _DepthStencilViewHeap, bool First)
{
}


bool DofPass::CreateRootSignature()
{
	HRESULT Result = S_OK;
...
bool DofPass::CreatePipeLineState()
{
	HRESULT Result = S_OK;
